**Exerpt from:** *"A Study between Light and Steel"*, author not known.


The Auralight, also referred to as simply "light" by [[Sephling]] Lightcasters, is a primordial energy source that originates from the sun. Although there has been disagreements on whether to classify it as an "energy", a "force or nature", or simply "will of the divine", the Auralight is perhaps known for being the motive that seems to drive both [[A Guide to Lightmancy | Lightmancy]] and [[Steelscience]]. In the Sephling language, it is commonly referred to as "*Er Mes*", which translates to "to be", as in, "it is simply to be". 

Collecting or observing the properties of the Auralight is very difficult, as it is not a physical property or a visible force. As a result, study into the Auralight is very difficult to come by, with scholars often times simply accepting it as a fact of life and moving on. However, it can be said that most of the interactions between [[A Guide to Lightmancy | Lightmancy]], [[Steelscience]], and other magic systems can be traced to the interactions the Auralight has in different environments. 
