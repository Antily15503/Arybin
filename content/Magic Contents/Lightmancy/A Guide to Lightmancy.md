...
**Preface**
Lightmancy is a system that's based on [[Auralight|light]]. The light that you see, the light that shines from the sun, they are all fuel waiting for you to draw upon them. The light in our environment is also a **finite quanta**, that is, it does not stay around for long, and quickly dissipates into [[entropy]]. Those that happen to capture light before it dissipates can be used as fuel in Lightmancy, and using it will convert that to entropy as well, though at an instantaneous rate. Light is always replenished in our world, and the most common source of it is from the sun as sunlight. Although there are also other sources of light out there, such as:
- Fires, which gives off light that is easier to burn for [[Red|Red Attunement]]
- Candlelight, which gives off either [[Red]] or [[Orange]] shifted light
...
Colors of Attunements
- [[Red]]: Infernal Tint
- [[Orange]]: Internal Tint
- [[Yellow]]: Radiance Tint
- [[Green]]: Corrosive Tint
- [[Blue]]: Cryonic Tint
- [[Indigo]]: Storm Tint
- [[Violet]]: Ionic Tint
Two "god tint"
- [[White]]: Restoration Tint
- [[Black]]: Destructive Tint